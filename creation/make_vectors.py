...
def main():
    ...
    command_line_parser.add_argument("--threads", type = int, default = 1, help = "Specify the number of threads used"
                                                                                  "while generating the vectors.")
    command_line_parser.add_argument("--dims", type = int, default = 50, help = "Specify the dimensionality of the word"
                                                                                "vectors.")
    command_line_parser.add_argument("--output-dir", type = str, help = "Specifiy a path to an output directory. If no"
                                                                        "such path is given, the output will be stored"
    ...
    model = gensim.models.Word2Vec(size=dims, min_count=min_count, sg = sg, negative=negative_samples, workers=threads, iter=iter)
